// PATCH  /api/opportunities/[id] — team sets the workflow status / notes
// DELETE /api/opportunities/[id] — drop an opportunity for good
...
import { updateOpportunity, deleteOpportunity } from '@/lib/opportunities/store'
import { isValidStatus, type OpportunityStatus } from '@/lib/opportunities/types'
...
export async function PATCH(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const patch: { status?: OpportunityStatus; notes?: string } = {}
