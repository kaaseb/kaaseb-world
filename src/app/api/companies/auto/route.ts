// GET  /api/companies/auto — is the daily auto-scan on?
// POST /api/companies/auto { on: boolean } — turn it on/off from the page.
...
export async function GET() {
  ...
  return NextResponse.json({ on: await getAutoScan('companies') })
}
...
export async function POST(request: Request) {
  ...
  await setAutoScan('companies', body.on)
